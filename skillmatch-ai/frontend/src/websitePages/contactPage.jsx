      ...
      <main className={styles.contact}>
        <div className={styles.contact__container}>
          ...
          <div className={styles.contact__header}>
            <Link to="/" className={styles.contact__back}>
            ...
            <h1>Get in Touch</h1>
            <p>Have questions or feedback? We would love to hear from you. Our team is here to help.</p>
          </div>
            ...
            <div className={styles.contact__info}>
              <div className={styles.contact__infoCard}>
                ...
                <div className={styles.contact__infoContent}>
                  <h3>Email Us</h3>
                  <a href="mailto:support.skillmatch.ai@gmail.com">support.skillmatch.ai@gmail.com</a>
            ...
            <div className={styles.contact__formWrapper}>
              {submitted ? (
                <div className={styles.contact__success}>
                  <div className={styles.contact__successIcon}>
